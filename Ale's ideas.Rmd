...
TO DO: function to recode answers from questions 1 and 2 (that have same options) 
...
ggplot(d, aes(povlev4_1718, k8q30)) +
  geom_col(color = "gray70") 

# don't understand why k8q30 is counted like that. Is counting number of responses?
```
