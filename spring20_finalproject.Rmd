...
# 1 custom function on missing data, nest, mutate and map2 to produce plot for 51 states (by Asha)
...
selected_data1$ace2more_1718[which(selected_data1$ace2more_1718==1)]<-"Exp No ACE"
selected_data1$ace2more_1718[which(selected_data1$ace2more_1718==2)]<-"Exp 1 ACE"
selected_data1$ace2more_1718[which(selected_data1$ace2more_1718==3)]<-"Exp 2 ACE"

selected_data1 <- selected_data1 %>%
  group_by(state, ace2more_1718) %>%
  count(ace2more_1718)
...
ggplot(selected_data1, aes(ace2more_1718, n)) +
  geom_col(aes(fill = n)) +
