...
# Three areas of strength in your code are: Good data cleaning up front. Super clean and easy to follow the code inside the code chunks. Nice iteration work with the output plots and saving. Thanks!

# One thing I learned from reviewing the script is: The way you passed the dots with ..1, ..2, and ..3 for plots (labels/ captions). Other than watching Daniel use the ..# in class, I have not seen this used in other code. I think the way you have passed the dots, especially inside labs() is starting to help me understand. I had to look at the code a couple of times to see where the dots were passed from but, it totally follows. Thanks!

# One area for improvement, a totally minor thing here: since you have 267 lines of code, simple code chunk labels inside {r } would help me navigate your code. You do a great job of specifying directly above each code chunk what you are going to do in the code chunk directly below. However, I find myself lost a bit between big code chunks with a somewhat similar function. Something simple like:
# {r confidence_reading},  {r confidence_ed_level},  
#  {r saving_plots},  at the start of the code chunk would be helpful for me. 
